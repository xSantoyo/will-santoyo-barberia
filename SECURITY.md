...
| R6 | **Contraseña seed compartida** (`WillSantoyo2026!` para admin y barberos). | Media | Forzar cambio en el primer login del dueño y de cada barbero (la pantalla `/admin/cuenta` ya existe). Documentado como paso de puesta en marcha. |
