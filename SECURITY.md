...
| R6 | **Contraseña seed en el código.** | ~~Media~~ **Resuelto** (ago-2026) | La clave salió del repositorio: se toma de `SEED_ADMIN_PASSWORD` o se genera aleatoria y se imprime una vez en el log del arranque. Sigue vigente forzar el cambio en el primer ingreso desde `/admin/cuenta`. |
